            ...
            <div class="hover-scroll-y mx-4" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                ...
                <div class="menu-item">
                    <a href="{{ route('card.index') }}"
                        class="menu-link {{ request()->routeIs(['card.index']) ? 'active show' : '' }}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a href="{{ route('card.orders') }}"
                        class="menu-link {{ request()->routeIs(['card.orders']) ? 'active show' : '' }}">
                        <span class="menu-icon">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-school"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M22 9l-10 -4l-10 4l10 4l10 -4v6" /><path d="M6 10.6v5.4a6 3 0 0 0 12 0v-5.4" /></svg>
                        </span>
                ...
                <div class="menu-item">
                    <a href="{{ route('blog.index') }}"
                        class="menu-link {{ request()->routeIs(['blog.index']) ? 'active show' : '' }}">
                        <span class="menu-icon">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-school"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M22 9l-10 -4l-10 4l10 4l10 -4v6" /><path d="M6 10.6v5.4a6 3 0 0 0 12 0v-5.4" /></svg>
                        </span>
